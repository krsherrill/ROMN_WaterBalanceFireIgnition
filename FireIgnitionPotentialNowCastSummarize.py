...
outputFolder = "C:\ROMN\Climate\ClimateAnalyzer\Dashboards\ROMO\GridMetStations\\" + siteName #Folder for the output Data Package Products - if Web = 'True' will be ignored
